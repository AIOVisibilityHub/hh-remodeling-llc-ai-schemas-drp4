...
### Root AI Files (6)
- https://hh-remodeling.aiovisibility.net/.nojekyll — Disable Jekyll on GitHub Pages
- https://hh-remodeling.aiovisibility.net/index.html — Landing page (redirects to ai-data.html)
- https://hh-remodeling.aiovisibility.net/llms.txt — LLM hint
- https://hh-remodeling.aiovisibility.net/manifest.json — Web app manifest
- https://hh-remodeling.aiovisibility.net/related-destinations.json — Cross-Destination Index (Related AI Data Sources)
...
- https://hh-remodeling.aiovisibility.net/reviews/anonymous-10-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/anonymous-11-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/anonymous-12-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/anonymous-13-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/anonymous-14-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/anonymous-8-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/anonymous-9-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/eric-s-1-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/kimbra-d-15-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/roger-w-2-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/verified-customer-4-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/verified-customer-5-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/verified-customer-6-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/verified-customer-7-review.json — schema
- https://hh-remodeling.aiovisibility.net/reviews/will-m-3-review.json — schema
